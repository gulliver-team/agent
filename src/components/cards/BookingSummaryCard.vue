...
<template>
    <div>
      ...
      <div class="text-sm text-zinc-700 dark:text-zinc-300">Hotel: <span class="font-medium">{{ props.data.hotel.name }}</span></div>
      <div class="text-sm text-zinc-700 dark:text-zinc-300">Venue: {{ props.data.venue.name }}</div>
      <div class="text-sm text-zinc-700 dark:text-zinc-300">Total: <span class="font-medium">${{ props.data.hotel.price }}</span> / night</div>
